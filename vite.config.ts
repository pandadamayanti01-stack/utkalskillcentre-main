...
export default defineConfig(({mode}) => {
  ...
  return {
    ...
    define: {
      ...
      'import.meta.env.VITE_RAZORPAY_KEY': JSON.stringify(env.VITE_RAZORPAY_KEY || process.env.VITE_RAZORPAY_KEY || ""),
    ...
    build: {
      rollupOptions: {
        ...
        input: {
          ...
          quizPortal: path.resolve(__dirname, 'quiz-portal.html'),
          ...
          primarySchoolWorksheets: path.resolve(__dirname, 'odia-medium-primary-school-practice-worksheets.html'),
          ...
          schoolScholarships: path.resolve(__dirname, 'odisha-school-scholarships-nmms-nrts.html'),
          sanskritHindiNotes: path.resolve(__dirname, 'odia-medium-sanskrit-and-hindi-study-notes.html'),
          scienceProjects: path.resolve(__dirname, 'odisha-school-science-projects-and-experiments.html'),
          syllabusNotifications: path.resolve(__dirname, 'bse-odisha-syllabus-and-exam-notifications.html'),
          odiaGkQuiz: path.resolve(__dirname, 'odia-gk-questions-and-online-quiz.html'),
          aiInOdisha: path.resolve(__dirname, 'ai-in-odisha.html'),
          osepaLessonPlannerAi: path.resolve(__dirname, 'osepa-lesson-planner-ai.html'),
          bseWorksheetGeneratorAi: path.resolve(__dirname, 'bse-odisha-worksheet-generator-ai.html'),
          zeroCostScienceProjects: path.resolve(__dirname, 'zero-cost-science-projects-odisha.html'),
          guestProfile: path.resolve(__dirname, 'guest-profile.html'),
          class5StudyMaterials: path.resolve(__dirname, 'class-5-study-materials-odisha.html'),
          class6StudyApp: path.resolve(__dirname, 'class-6-study-app-odisha.html'),
          odiaMathFormulas: path.resolve(__dirname, 'odia-medium-math-formulas-pdf.html'),
          class10BoardTips: path.resolve(__dirname, 'class-10-board-exam-tips-odisha.html'),
        },
      },
    },
    publicDir: 'public',
