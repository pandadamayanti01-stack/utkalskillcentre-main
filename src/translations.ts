  ...
  en: {
    ...
    subjectsByClass: {
      odisha: {
        ...
        class9: ['odia', 'odia_grammar', 'english', 'english_grammar', 'hindi', 'hindi_grammar', 'sanskrit', 'sanskrit_grammar', 'algebra', 'geometry', 'life_science', 'physical_science', 'social_science'],
        class10: ['odia', 'odia_grammar', 'english', 'english_grammar', 'hindi', 'hindi_grammar', 'sanskrit', 'sanskrit_grammar', 'algebra', 'geometry', 'life_science', 'physical_science', 'social_science', 'vocational'],
      },
      aurobindo: {
        class1: ['odia', 'math', 'english', 'art_health'],
        class2: ['odia', 'math', 'english', 'art_health'],
