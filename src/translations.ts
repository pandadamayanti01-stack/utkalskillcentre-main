export const translations: any = {
  en: {
    ...
    monthlyTestChampions: "Monthly Test Champions",
    noMonthlyData: "No monthly test data available for the selected month/class.",
    leagues: "Leagues",
    friends: "Friends",
  ...
  or: {
    ...
    monthlyTest: "ମାସିକ ଟେଷ୍ଟ",
    monthlyTestChampions: "ମାସିକ ଟେଷ୍ଟ ଚାମ୍ପିଅନ୍ସ",
    noMonthlyData: "ଚୟନିତ ମାସ/ଶ୍ରେଣୀ ପାଇଁ କୌଣସି ମାସିକ ଟେଷ୍ଟ ତଥ୍ୟ ଉପଲବ୍ଧ ନାହିଁ।",
    leagues: "ଲିଗ୍",
    friends: "ସାଙ୍ଗମାନେ",
