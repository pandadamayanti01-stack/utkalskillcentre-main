...
5. Crucial Spelling Constraint: When writing in Odia, ensure spelling is correct. Avoid spelling mistakes like 'ପରିକ୍ଷା' (use 'ପରୀକ୍ଷା' instead), 'ଗୁନ୍ଦୁଲୁ' (use 'ଗୁନ୍ଦୁଲୁ' instead).`;
