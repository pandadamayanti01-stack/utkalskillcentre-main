...
export function DailyMcqView({ mcqs, submissions, user, language, onBack }: DailyMcqViewProps) {
  ...
  const t = language === 'en'
    ? {
        ...
        forClass: 'For',
        back: 'Dashboard',
        scheduleNotice: 'New Daily MCQs are published Monday to Saturday at 6 AM. Keep studying!',
    ...
    : {
        ...
        forClass: 'ପାଇଁ',
        back: 'ଡ୍ୟାସବୋର୍ଡ',
        scheduleNotice: 'ସୋମବାର ରୁ ଶନିବାର ପର୍ଯ୍ୟନ୍ତ ସକାଳ ୬ ଟାରେ ନୂଆ ଦୈନିକ MCQ ଆସେ। ନିଜର ପଢା ଜାରି ରଖନ୍ତୁ।',
